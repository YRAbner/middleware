package com.myitem.middleware.hystrix.value.impl;
 ...
 * @date: 2022/2/22 7:12
 */
public class HystrixValveServiceImpl extends HystrixCommand<Object> implements IValveService {
    private ProceedingJoinPoint proceedingJoinPoint;
    private Method method;
    private DoHystrix doHystrix;

    public HystrixValveServiceImpl() {
